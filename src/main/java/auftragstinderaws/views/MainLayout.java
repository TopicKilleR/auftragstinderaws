package auftragstinderaws.views;

import auftragstinderaws.data.entity.User;
import auftragstinderaws.security.AuthenticatedUser;
import auftragstinderaws.views.about.AboutView;
import auftragstinderaws.views.addressform.AddressFormView;
import auftragstinderaws.views.cardlist.CardListView;
import auftragstinderaws.views.checkoutform.CheckoutFormView;
import auftragstinderaws.views.helloworld.HelloWorldView;
import auftragstinderaws.views.imagelist.ImageListView;
import auftragstinderaws.views.personform.PersonFormView;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("AuftragstinderAws");
